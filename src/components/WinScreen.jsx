...
/**
 * WinScreen - Congratulations screen after completing the puzzle
 * 
 * @param {Object} props - Component props
 * @param {number} props.moves - Number of moves taken
 * @param {number} props.time - Time taken in seconds
 * @param {number} props.targetTime - Target time in seconds
 * @param {Function} props.onContinue - Callback for play again
 * @param {Function} props.onClaimPrize - Callback for claiming prize
 */
export function WinScreen({ 
  ...
  // Check if completed in target time
    ...
    >
      <div className="relative z-10 flex flex-col items-center text-center px-8 max-w-lg">
        ...
        <motion.div
          ...
          style={{
            backgroundColor: `${config.theme.gold}20`,
            border: `3px solid ${config.theme.gold}`,
          }}
          animate={{
            boxShadow: [
        ...
        >
          <p 
            ...
            style={{ color: config.theme.gold, fontFamily: config.fonts.display }}
          >
            {config.game.prize}
          </p>
        </motion.div>
      ...
      <div 
        ...
        style={{
          background: `radial-gradient(circle, ${config.theme.success}20 0%, transparent 70%)`,
        }}
      />
    </motion.div>
  );
  ...
  return (
    <div 
      ...
      style={{
        ...
        border: `1px solid ${config.theme.primary}40`,
      }}
    >
      <span 
