...
/**
 * GameTimer - Display game timer
 */
export function GameTimer({ time, targetTime, isRunning }) {
  ...
  return (
    <motion.div
      ...
      style={{
        backgroundColor: isDanger ? `${config.theme.error}20` : 
                         isWarning ? `${config.theme.gold}20` : 
                         `${config.theme.primary}15`,
        border: `2px solid ${isDanger ? config.theme.error : 
                          isWarning ? config.theme.gold : 
    ...
    >
      ...
      <span 
        ...
        style={{ 
          color: isDanger ? config.theme.error : 
                  isWarning ? config.theme.gold : 
                  config.theme.primary,
