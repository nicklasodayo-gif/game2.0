...
/**
 * LeadCapture - Form for collecting user details after winning
 * 
 * @param {Object} props - Component props
 * @param {Function} props.onSubmit - Callback with form data
 * @param {Function} props.onSkip - Callback when skipping
 */
export function LeadCapture({ onSubmit, onSkip }) {
        ...
        >
          ...
          <div className="flex items-start gap-3">
            ...
            <label 
              ...
              style={{ color: config.theme.text, opacity: 0.8 }}
            >
