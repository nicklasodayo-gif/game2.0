 ...
 * Switch to this config by: import config from './redGiant'
 */
...
const redGiantConfig = {
  ...
  lead: {
    ...
    consentText: "Your information will only be used for this competition. We respect your privacy and will not share your details.",
